...
from ddns_clienter.core import models
from ddns_clienter.core.constants import AddressInfo
from ddns_clienter.core.runtimes.address_providers import (
    AddressProviderException,
    get_ip_address_from_provider,
)
from ddns_clienter.core.runtimes.config import (
    AddressProviderConfig,
    ConfigException,
    TaskConfig,
    get_config,
)
from ddns_clienter.core.runtimes.dns_providers import (
    ...
    async def __call__(self):
        ...
        for task_config in self.task_configs:
            ...
            if (
                ...
                and (
                    address_info.ipv4_address_str
                    not in task_db.last_ip_addresses.split(",")
